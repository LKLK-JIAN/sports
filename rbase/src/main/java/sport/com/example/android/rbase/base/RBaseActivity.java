...
import sport.com.example.android.rbase.R;

/**
 * Created by android on 2018/3/27.
 */

public abstract  class RBaseActivity<T extends IRBasePresenter,V extends ViewDataBinding>
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ActivityCollector.addActivity(mContext);
        ...
        if(layoutID!=0){
            ...
            mDingding= DataBindingUtil.setContentView(mContext,layoutID);
        }
        //获取当前主题的颜色
        initThemeAttrs();
        //初始化沉浸栏的颜色
